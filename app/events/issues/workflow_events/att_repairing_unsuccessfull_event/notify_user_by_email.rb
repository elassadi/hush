module Issues
  module WorkflowEvents
    module AttRepairingUnsuccessfullEvent
      class NotifyUserByEmail < BaseWorkflowEvent
        subscribe_to :after_transition_to_repairing_unsuccessfull
        ...
        def send_email
          IssueMailer.call(
            issue:,
            documents: [issue.repair_report_document],
        ...
        def notification_rule
          @notification_rule ||= ApplicationSetting.customer_notification_for(
            trigger: :issue_repairing_unsuccessfull,
            channel: :mail
          )
        end
      end
