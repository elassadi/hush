RSpec.describe CalendarEntries::ConfirmTransaction do
  describe "#call" do
    subject(:call) do
    ...
    let(:operation) do
      instance_double(CalendarEntries::ConfirmOperation)
    end

    before do
      allow(CalendarEntries::ConfirmOperation).to receive(:new)
