RSpec.describe IssueCalendarEntries::CreateTransaction do
  describe "#call" do
    subject(:call) do
    ...
    let(:operation) do
      instance_double(IssueCalendarEntries::CreateOperation)
    end

    before do
      allow(IssueCalendarEntries::CreateOperation).to receive(:new)
        .with(attributes)
