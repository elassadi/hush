RSpec.describe IssueEntries::UpdateStockReservationTransaction do
  describe "#call" do
    subject(:call) do
    ...
    let(:operation) do
      instance_double(IssueEntries::UpdateStockReservationOperation)
    end
    ...
    before do
      allow(IssueEntries::UpdateStockReservationOperation).to receive(:new).and_return(operation)
    end
