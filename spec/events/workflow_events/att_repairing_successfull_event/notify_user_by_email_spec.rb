RSpec.describe Issues::WorkflowEvents::AttRepairingSuccessfullEvent::NotifyUserByEmail do
  describe "#call" do
    subject(:call) do
      described_class.call(resource_id: issue.id, resource_class: issue.class.to_s,
                           from: "repairing", to: "repairing_successfull", triggering_event: "triggering_event",
